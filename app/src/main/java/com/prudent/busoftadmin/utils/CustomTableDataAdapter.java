...
/**
 * Created by Dharmik Patel on 12-Jul-17.
 */
...
public class CustomTableDataAdapter extends TableDataAdapter<String[]> {
    ...
    public CustomTableDataAdapter(final Context context, final String[][] data) {
        super(context, data);
    }

    public CustomTableDataAdapter(final Context context, final List<String[]> data) {
        super(context, data);
    }
