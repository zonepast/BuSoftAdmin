...
public class ChequeReceiptBaseRateSpinner extends ArrayAdapter<CustomSpinner> {
    ...
    public ChequeReceiptBaseRateSpinner(Context context, List<CustomSpinner> objects) {
